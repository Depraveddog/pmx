...
// Helper: strip markdown fences if the model wraps JSON in ```json ... ```
...
[
  {
    ...
    try {
      ...
      risks = [
        {
          id: "R1",
          description: "Scope may expand beyond initial objectives if requirements are unclear.",
          category: "Scope",
          impact: "High",
          probability: "Medium",
          response: "Define a clear scope baseline and implement change control.",
...
${ctx}
    ...
    try {
      ...
      // Sensible fallback
      wbs = [
        { id: "1", name: "Initiation", startWeek: 0, durationWeeks: 1, items: ["1.1 Define project scope", "1.2 Identify stakeholders"] },
        { id: "2", name: "Planning", startWeek: 1, durationWeeks: 2, items: ["2.1 Create project plan", "2.2 Risk assessment"] },
        { id: "3", name: "Execution", startWeek: 3, durationWeeks: 5, items: ["3.1 Deliver core work", "3.2 Track progress"] },
        { id: "4", name: "Closure", startWeek: 8, durationWeeks: 1, items: ["4.1 Final review", "4.2 Handover"] },
      ];
      tasks = [
